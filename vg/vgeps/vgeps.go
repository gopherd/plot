...
package vgeps // import "github.com/gopherd/plot/vg/vgeps"
...
func NewTitle(w, h vg.Length, title string) *Canvas {
	...
	c.buf.WriteString("%%Creator github.com/gopherd/plot/vg/vgeps\n")
...
func (c *Canvas) DrawImage(rect vg.Rectangle, img image.Image) {
	// FIXME: https://github.com/gopherd/plot/issues/271
